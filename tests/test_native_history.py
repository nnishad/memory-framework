...
def opened(path):
    """A SQLite connection that is also closed. ``with conn`` only commits; on
    Windows the lingering handle breaks the temporary-directory teardown."""
