...
|---|---:|---:|---:|
| lexical | 14/23 | 17/24 | 4.09 |
| multilingual_hybrid | 16/23 | 23/24 | 45.53 |
...
- lexical: Who fixed my automobile? Expected ['garage']; retrieved [].
...
- lexical: Where did I put my travel identity document? Expected ['passport']; retrieved [].
- lexical: मेरा पासपोर्ट कहाँ रखा है? Expected ['passport']; retrieved ['hindi'].
- lexical: How much rest did I get overnight? Expected ['rest']; retrieved [].
- lexical: Where is my blue bicycle key? Expected ['hindi']; retrieved ['recommend', 'background-0013', 'background-0058', 'background-0069', 'background-0074'].
...
- lexical: What is my submarine registration number? Returned 0 candidates; sufficiency `not_established`.
- lexical: What is my blood type? Returned 0 candidates; sufficiency `not_established`.
- lexical: What is my private helicopter tail number? Returned 0 candidates; sufficiency `not_established`.
- multilingual_hybrid: What is my submarine registration number? Returned 0 candidates; sufficiency `not_established`.
- multilingual_hybrid: What is my blood type? Returned 0 candidates; sufficiency `not_established`.
- multilingual_hybrid: What is my private helicopter tail number? Returned 0 candidates; sufficiency `not_established`.
